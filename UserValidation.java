...
public class UserValidation {
    public static void main(String[] args) {
        ...
        Users invalidUser = new Users(
            null, "a", "test123", 12456, "javatechnology", "db", "", "1234", "y", -2, 1,
            new Date(), getPastOrFutureDate(-2), getPastOrFutureDate(2), 5, "sample1.com", "123@"
        );
        ...
        Users validUser = new Users(1L, "author", "a@gmail.com", 16, "4", "3", "ML", null, "YN", 2, 0,
            getPastOrFutureDate(2), getPastOrFutureDate(1), getPastOrFutureDate(-2), 2, "https://www.vsb.org/", "9784564123214");
